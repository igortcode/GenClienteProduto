...
namespace GCP.Front.Forms
{
    partial class ClientForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // tabControlCliente
            // 
            tabControlCliente.Controls.Add(tabList);
            tabControlCliente.Controls.Add(tabAdd);
            tabControlCliente.Controls.Add(tabEdit);
            tabControlCliente.Location = new Point(12, 17);
            tabControlCliente.Name = "tabControlCliente";
            tabControlCliente.SelectedIndex = 0;
            tabControlCliente.Size = new Size(979, 551);
            tabControlCliente.SizeMode = TabSizeMode.FillToRight;
            tabControlCliente.TabIndex = 1;
            // 
            // tabList
            // 
